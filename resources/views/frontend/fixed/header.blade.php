                        ...
                        <div class="main-menu d-none d-lg-block">
                            <nav>
                                <ul id="navigation" class="list-unstyled d-flex m-0">
                                    ...
                                    <li class="nav-item"><a href="#" class="nav-link px-3" style="color: #333; font-weight: 500; transition: color 0.3s ease;" onmouseenter="this.style.color='#ff2020'" onmouseleave="this.style.color='#333'">Women</a></li>
                                    <li class="nav-item"><a href="#" class="nav-link px-3" style="color: #333; font-weight: 500; transition: color 0.3s ease;" onmouseenter="this.style.color='#ff2020'" onmouseleave="this.style.color='#333'">Baby Collection</a></li>
                                    ...
                                    <li class="nav-item"><a href="#" class="nav-link px-3" style="color: #333; font-weight: 500; transition: color 0.3s ease;" onmouseenter="this.style.color='#ff2020'" onmouseleave="this.style.color='#333'">Contact</a></li>
                                </ul>
                            </nav>
                        </div>
                                ...
                                <li class="nav-item">
                                    <div class="dropdown">
                                        ...
                                        <ul class="dropdown-menu dropdown-menu-end"
                                            style="min-width: 200px; box-shadow: 0 2px 15px rgba(0,0,0,0.1); border-radius: 4px; margin-top: 10px;">
                                            <li>
                                                <a href="{{route('customer.register')}}" class="dropdown-item"
                                                    style="padding: 10px 20px; color: #333; font-weight: 500; transition: all 0.3s ease;">
                                                    Register
                                                </a>
                                            </li>
                                        </ul>
